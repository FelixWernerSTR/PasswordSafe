...
public class EntryResource {
    ...
    private static final String ENTITY_NAME = "passwordSafeEntry";
     ...
     */
    @GetMapping("/entries")
    public ResponseEntity<List<Entry>> getAllEntries(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
