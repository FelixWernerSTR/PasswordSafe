<template>
  <b-navbar data-cy="navbar" toggleable="md" type="dark" class="bg-primary">
    <b-navbar-brand class="logo" b-link to="/">
      ...
      <span v-text="$t('global.title')" class="navbar-title">SVISInfo</span> <span class="navbar-version">{{ version }}</span>
    </b-navbar-brand>
    <b-navbar-toggle
      right
    ...
    <b-collapse is-nav id="header-tabs">
      <b-navbar-nav class="ml-auto">
        ...
        <b-nav-item-dropdown right id="entity-menu" v-if="authenticated" active-class="active" class="pointer" data-cy="entity">
          ...
          <b-dropdown-item to="/thementyp">
            <font-awesome-icon icon="asterisk" />
            <span v-text="$t('global.menu.entities.thementyp')">Thementyp</span>
          </b-dropdown-item>
          <b-dropdown-item to="/thema">
            <font-awesome-icon icon="asterisk" />
            <span v-text="$t('global.menu.entities.thema')">Thema</span>
          </b-dropdown-item>
          <b-dropdown-item to="/beitrag">
            <font-awesome-icon icon="asterisk" />
            <span v-text="$t('global.menu.entities.beitrag')">Beitrag</span>
          </b-dropdown-item>
