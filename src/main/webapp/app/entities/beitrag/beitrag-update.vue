  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="svisInfoApp.beitrag.home.createOrEditLabel"
          data-cy="BeitragCreateUpdateHeading"
          v-text="$t('svisInfoApp.beitrag.home.createOrEditLabel')"
        >
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('svisInfoApp.beitrag.content')" for="beitrag-content">Content</label>
            <textarea
              class="form-control"
              name="content"
              id="beitrag-content"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('svisInfoApp.beitrag.attrib')" for="beitrag-attrib">Attrib</label>
            <input
              type="text"
              class="form-control"
              name="attrib"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('svisInfoApp.beitrag.titel')" for="beitrag-titel">Titel</label>
            <input
              type="text"
              class="form-control"
              name="titel"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('svisInfoApp.beitrag.rechte')" for="beitrag-rechte">Rechte</label>
            <input
              type="text"
              class="form-control"
              name="rechte"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('svisInfoApp.beitrag.validFrom')" for="beitrag-validFrom">Valid From</label>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('svisInfoApp.beitrag.validTo')" for="beitrag-validTo">Valid To</label>
            <b-input-group class="mb-3">
              <b-input-group-prepend>
                <b-form-datepicker
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('svisInfoApp.beitrag.publishDate')" for="beitrag-publishDate">Publish Date</label>
            <b-input-group class="mb-3">
              <b-input-group-prepend>
                <b-form-datepicker
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('svisInfoApp.beitrag.archiv')" for="beitrag-archiv">Archiv</label>
            <select
              class="form-control"
              name="archiv"
              ...
              data-cy="archiv"
            >
              <option value="JA" v-bind:label="$t('svisInfoApp.Archiv.JA')">Ja</option>
              <option value="NEIN" v-bind:label="$t('svisInfoApp.Archiv.NEIN')">Nein</option>
            </select>
          </div>
          <div class="form-group">
            <label class="form-control-label" v-text="$t('svisInfoApp.beitrag.thema')" for="beitrag-thema">Thema</label>
