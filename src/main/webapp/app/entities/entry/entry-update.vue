  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="passwortverwaltungApp.entry.home.createOrEditLabel"
          data-cy="EntryCreateUpdateHeading"
          v-text="$t('passwortverwaltungApp.entry.home.createOrEditLabel')"
        >
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('passwortverwaltungApp.entry.description')" for="entry-description"
              >Description</label
            >
            <input
              type="text"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('passwortverwaltungApp.entry.login')" for="entry-login">Login</label>
            <input
              type="text"
              class="form-control"
              name="login"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('passwortverwaltungApp.entry.passwort')" for="entry-passwort">Passwort</label>
            <input
              type="text"
              class="form-control"
              name="passwort"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('passwortverwaltungApp.entry.passwortReplay')" for="entry-passwortReplay"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('passwortverwaltungApp.entry.group')" for="entry-group">Group</label>
