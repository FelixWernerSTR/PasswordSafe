  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="passwordSafeApp.entry.home.createOrEditLabel"
          data-cy="EntryCreateUpdateHeading"
          v-text="$t('passwordSafeApp.entry.home.createOrEditLabel')"
        >
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('passwordSafeApp.entry.description')" for="entry-description">Description</label>
            <input
              type="text"
              class="form-control"
              name="description"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('passwordSafeApp.entry.login')" for="entry-login">Login</label>
            <input
              type="text"
              class="form-control"
              name="login"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('passwordSafeApp.entry.passwort')" for="entry-passwort">Passwort</label>
            <input
              type="text"
              class="form-control"
              name="passwort"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('passwordSafeApp.entry.passwortReplay')" for="entry-passwortReplay"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('passwordSafeApp.entry.group')" for="entry-group">Group</label>
