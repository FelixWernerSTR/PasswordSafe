  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="passwortverwaltungApp.group.home.createOrEditLabel"
          data-cy="GroupCreateUpdateHeading"
          v-text="$t('passwortverwaltungApp.group.home.createOrEditLabel')"
        >
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('passwortverwaltungApp.group.name')" for="group-name">Name</label>
            <input
              type="text"
              class="form-control"
              name="name"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('passwortverwaltungApp.group.description')" for="group-description"
              >Description</label
            >
            <input
              type="text"
