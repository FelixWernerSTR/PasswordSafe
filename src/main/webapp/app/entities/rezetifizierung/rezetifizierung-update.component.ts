    ...
    if (this.rezetifizierung.id) {
      this.rezetifizierungService()
        ...
        .then(param => {
          this.isSaving = false;
          this.$router.go(-1);
          const message = this.$t('svisRezetifizierungApp.rezetifizierung.updated', { param: param.id });
      ...
      this.rezetifizierungService()
        ...
        .then(param => {
          this.isSaving = false;
          this.$router.go(-1);
          const message = this.$t('svisRezetifizierungApp.rezetifizierung.created', { param: param.id });
