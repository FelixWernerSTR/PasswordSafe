  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="kpmgApp.rezetifizierung.home.createOrEditLabel"
          data-cy="RezetifizierungCreateUpdateHeading"
          v-text="$t('kpmgApp.rezetifizierung.home.createOrEditLabel')"
        >
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('kpmgApp.rezetifizierung.loginName')" for="rezetifizierung-loginName"
              >Login Name</label
            >
            <input
              type="text"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('kpmgApp.rezetifizierung.nachname')" for="rezetifizierung-nachname"
              >Nachname</label
            >
            <input
              type="text"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('kpmgApp.rezetifizierung.vorname')" for="rezetifizierung-vorname">Vorname</label>
            <input
              type="text"
              class="form-control"
              name="vorname"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('kpmgApp.rezetifizierung.vermittlerNummer')" for="rezetifizierung-vermittlerNummer"
          ...
          <div class="form-group">
            <label
              ...
              v-text="$t('kpmgApp.rezetifizierung.rollenZugehoerigkeiten')"
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="$t('kpmgApp.rezetifizierung.dvcVertreterNummer')"
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="$t('kpmgApp.rezetifizierung.dvcBenutzerGruppe')"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('kpmgApp.rezetifizierung.icisSrGebaude')" for="rezetifizierung-icisSrGebaude"
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="$t('kpmgApp.rezetifizierung.icisSrHaftpflicht')"
          ...
          <div class="form-group">
            <label
              class="form-control-label"
              v-text="$t('kpmgApp.rezetifizierung.icisSrLeitungswasser')"
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('kpmgApp.rezetifizierung.icisSrKfzKasko')" for="rezetifizierung-icisSrKfzKasko"
