      ...
      <table class="table table-striped" aria-describedby="rezetifizierungs">
        <thead>
          <tr>
            ...
            <th scope="row"><span v-text="$t('svisRezetifizierungApp.rezetifizierung.loginName')">Login Name</span></th>
            <th scope="row"><span v-text="$t('svisRezetifizierungApp.rezetifizierung.nachname')">Nachname</span></th>
            <th scope="row"><span v-text="$t('svisRezetifizierungApp.rezetifizierung.vorname')">Vorname</span></th>
            <th scope="row"><span v-text="$t('svisRezetifizierungApp.rezetifizierung.vermittlerNummer')">Vermittler Nummer</span></th>
            <th scope="row">
              <span v-text="$t('svisRezetifizierungApp.rezetifizierung.rollenZugehoerigkeiten')">Rollen Zugehoerigkeiten</span>
            </th>
            <th scope="row"><span v-text="$t('svisRezetifizierungApp.rezetifizierung.dvcVertreterNummer')">Dvc Vertreter Nummer</span></th>
            <th scope="row"><span v-text="$t('svisRezetifizierungApp.rezetifizierung.dvcBenutzerGruppe')">Dvc Benutzer Gruppe</span></th>
            <th scope="row"><span v-text="$t('svisRezetifizierungApp.rezetifizierung.icisSrGebaude')">Icis Sr Gebaude</span></th>
            <th scope="row"><span v-text="$t('svisRezetifizierungApp.rezetifizierung.icisSrHaftpflicht')">Icis Sr Haftpflicht</span></th>
            <th scope="row">
              <span v-text="$t('svisRezetifizierungApp.rezetifizierung.icisSrLeitungswasser')">Icis Sr Leitungswasser</span>
            </th>
            <th scope="row"><span v-text="$t('svisRezetifizierungApp.rezetifizierung.icisSrKfzKasko')">Icis Sr Kfz Kasko</span></th>
            <th scope="row"></th>
          </tr>
        </thead>
        <tbody>
