...
export default class Thema extends mixins(JhiDataUtils) {
  ...
  public prepareRemove(instance: IThema): void {
  ...
  public removeThema(): void {
    this.themaService()
      .delete(this.removeId)
      .then(() => {
        const message = this.$t('svisInfoApp.thema.deleted', { param: this.removeId });
