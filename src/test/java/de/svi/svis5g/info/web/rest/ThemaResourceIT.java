...
class ThemaResourceIT {
        ...
        restThemaMockMvc
            .perform(
                post(ENTITY_API_URL)
                    ...
                    .content(TestUtil.convertObjectToJsonBytes(themaDTO))
            )
    ...
    void putNewThema() throws Exception {
        ...
        ThemaDTO themaDTO = themaMapper.toDto(updatedThema);

        restThemaMockMvc
            .perform(
                put(ENTITY_API_URL_ID, themaDTO.getId())
                    .with(csrf())
                    .contentType(MediaType.APPLICATION_JSON)
                    .content(TestUtil.convertObjectToJsonBytes(themaDTO))
            )
    ...
    void partialUpdateThemaWithPatch() throws Exception {
        ...
        partialUpdatedThema.rechte(UPDATED_RECHTE);
    ...
    void patchNonExistingThema() throws Exception {
        ...
        restThemaMockMvc
            .perform(
                patch(ENTITY_API_URL_ID, themaDTO.getId())
                    .with(csrf())
                    .contentType("application/merge-patch+json")
                    .content(TestUtil.convertObjectToJsonBytes(themaDTO))
            )
