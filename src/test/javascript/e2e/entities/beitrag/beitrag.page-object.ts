...
export default class BeitragComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('beitrag-heading'));
...
export class BeitragDeleteDialog {
  dialog: ElementFinder = element(by.id('removeEntity'));
  title: ElementFinder = element(by.id('svisInfoApp.beitrag.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-beitrag'));
}
