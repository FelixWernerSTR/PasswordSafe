...
describe('Beitrag e2e test', () => {
  ...
  describe('Create flow', () => {
    ...
    it('should create and save Beitrags', async () => {
      ...
      expect(await updatePage.attribInput.getAttribute('value')).to.match(/attrib/);
      ...
      expect(await updatePage.validFromInput.getAttribute('value')).to.eq('2001-01-01');

      await updatePage.validToInput.sendKeys('2001-01-01');
      expect(await updatePage.validToInput.getAttribute('value')).to.eq('2001-01-01');

      await updatePage.publishDateInput.sendKeys('2001-01-01');
      expect(await updatePage.publishDateInput.getAttribute('value')).to.eq('2001-01-01');
    ...
    describe('Details, Update, Delete flow', () => {
      ...
      it('should load edit Beitrag page, fetch data and update', async () => {
        ...
        expect(await updatePage.attribInput.getAttribute('value')).to.match(/modified/);
        ...
        expect(await updatePage.validFromInput.getAttribute('value')).to.eq('2019-01-01');

        await updatePage.validToInput.clear();
        await updatePage.validToInput.sendKeys('2019-01-01');
        expect(await updatePage.validToInput.getAttribute('value')).to.eq('2019-01-01');

        await updatePage.publishDateInput.clear();
        await updatePage.publishDateInput.sendKeys('2019-01-01');
        expect(await updatePage.publishDateInput.getAttribute('value')).to.eq('2019-01-01');
