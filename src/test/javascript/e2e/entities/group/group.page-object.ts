...
export default class GroupComponentsPage extends AlertPage {
...
export class GroupDeleteDialog {
  ...
  title: ElementFinder = element(by.id('passwortverwaltungApp.group.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-group'));
}
