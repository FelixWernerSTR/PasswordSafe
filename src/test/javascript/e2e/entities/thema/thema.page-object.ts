...
export default class ThemaComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('thema-heading'));
...
export class ThemaDeleteDialog {
  dialog: ElementFinder = element(by.id('removeEntity'));
  title: ElementFinder = element(by.id('svisInfoApp.thema.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-thema'));
}
