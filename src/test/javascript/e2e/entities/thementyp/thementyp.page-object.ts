...
export default class ThementypComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('thementyp-heading'));
...
export class ThementypDeleteDialog {
  dialog: ElementFinder = element(by.id('removeEntity'));
  title: ElementFinder = element(by.id('svisInfoApp.thementyp.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-thementyp'));
}
